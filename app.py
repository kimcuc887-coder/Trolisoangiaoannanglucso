...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Kim Cúc - Trường Tiểu học Quyết Tiến - ĐT: 098 4201 487</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  Nguyễn Thị Kim Cúc - Trường Tiểu học Quyết Tiến - ĐT: 098 4201 487</div>", unsafe_allow_html=True)
